...
fmtname(char *path)
{
  ...
  cf:	ba 1e 00 00 00       	mov    $0x1e,%edx
...
ls(char *path)
{
 ...
 104:	56                   	push   %esi
 105:	53                   	push   %ebx
 106:	81 ec 74 02 00 00    	sub    $0x274,%esp
 ...
 11c:	0f 88 9e 01 00 00    	js     2c0 <ls+0x1c0>
  ...
  if(fstat(fd, &st) < 0){
 122:	8d b5 b4 fd ff ff    	lea    -0x24c(%ebp),%esi
 ...
 139:	0f 88 c1 01 00 00    	js     300 <ls+0x200>
  ...
  switch(st.type){
 13f:	0f b7 85 b4 fd ff ff 	movzwl -0x24c(%ebp),%eax
 ...
 155:	8b 95 c4 fd ff ff    	mov    -0x23c(%ebp),%edx
 15b:	8b b5 bc fd ff ff    	mov    -0x244(%ebp),%esi
 161:	57                   	push   %edi
 162:	89 95 a4 fd ff ff    	mov    %edx,-0x25c(%ebp)
 168:	e8 f3 fe ff ff       	call   60 <fmtname>
 16d:	8b 95 a4 fd ff ff    	mov    -0x25c(%ebp),%edx
 173:	59                   	pop    %ecx
 174:	5f                   	pop    %edi
 175:	52                   	push   %edx
 176:	56                   	push   %esi
 ...
 1c3:	57                   	push   %edi
 1c4:	8d bd c8 fd ff ff    	lea    -0x238(%ebp),%edi
 1ca:	50                   	push   %eax
 ...
 1ea:	8d 84 05 e9 fd ff ff 	lea    -0x217(%ebp,%eax,1),%eax
    ...
    strcpy(buf, path);
    p = buf+strlen(buf);
 1f1:	89 8d 98 fd ff ff    	mov    %ecx,-0x268(%ebp)
    *p++ = '/';
 1f7:	89 85 94 fd ff ff    	mov    %eax,-0x26c(%ebp)
 ...
 20f:	83 f8 20             	cmp    $0x20,%eax
 212:	0f 85 71 ff ff ff    	jne    189 <ls+0x89>
      if(de.inum == 0)
 218:	66 83 bd c8 fd ff ff 	cmpw   $0x0,-0x238(%ebp)
 21f:	00 
 220:	74 de                	je     200 <ls+0x100>
        continue;
      memmove(p, de.name, DIRSIZ);
 222:	8d 85 ca fd ff ff    	lea    -0x236(%ebp),%eax
 228:	83 ec 04             	sub    $0x4,%esp
 22b:	6a 1e                	push   $0x1e
 22d:	50                   	push   %eax
 22e:	ff b5 94 fd ff ff    	pushl  -0x26c(%ebp)
 234:	e8 17 03 00 00       	call   550 <memmove>
      p[DIRSIZ] = 0;
 239:	8b 85 98 fd ff ff    	mov    -0x268(%ebp),%eax
 23f:	c6 40 1f 00          	movb   $0x0,0x1f(%eax)
      if(stat(buf, &st) < 0){
 243:	58                   	pop    %eax
 ...
 257:	0f 88 c3 00 00 00    	js     320 <ls+0x220>
      ...
      printf(1, "%s %d %d %d\n", fmtname(buf), st.type, st.ino, st.size);
 25d:	8b 8d c4 fd ff ff    	mov    -0x23c(%ebp),%ecx
 263:	0f bf 85 b4 fd ff ff 	movswl -0x24c(%ebp),%eax
 26a:	83 ec 0c             	sub    $0xc,%esp
 26d:	8b 95 bc fd ff ff    	mov    -0x244(%ebp),%edx
 273:	89 8d 9c fd ff ff    	mov    %ecx,-0x264(%ebp)
 279:	8d 8d e8 fd ff ff    	lea    -0x218(%ebp),%ecx
 27f:	89 95 a0 fd ff ff    	mov    %edx,-0x260(%ebp)
 285:	89 85 a4 fd ff ff    	mov    %eax,-0x25c(%ebp)
 28b:	51                   	push   %ecx
 28c:	e8 cf fd ff ff       	call   60 <fmtname>
 291:	5a                   	pop    %edx
 292:	8b 95 a0 fd ff ff    	mov    -0x260(%ebp),%edx
 298:	59                   	pop    %ecx
 299:	8b 8d 9c fd ff ff    	mov    -0x264(%ebp),%ecx
 29f:	51                   	push   %ecx
 2a0:	52                   	push   %edx
 2a1:	ff b5 a4 fd ff ff    	pushl  -0x25c(%ebp)
 2a7:	50                   	push   %eax
...
free(void *ap)
{
 ...
 8a1:	a1 a0 0d 00 00       	mov    0xda0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 8f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8f9:	a3 a0 0d 00 00       	mov    %eax,0xda0
}
 8fe:	5b                   	pop    %ebx
 8ff:	5e                   	pop    %esi
 900:	5f                   	pop    %edi
 ...
 91a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 91d:	a3 a0 0d 00 00       	mov    %eax,0xda0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 939:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 93c:	8b 15 a0 0d 00 00    	mov    0xda0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 98f:	76 3f                	jbe    9d0 <malloc+0xa0>
    ...
    if(p == freep)
 991:	39 05 a0 0d 00 00    	cmp    %eax,0xda0
 ...
 9b6:	e8 e5 fe ff ff       	call   8a0 <free>
  return freep;
 9bb:	8b 15 a0 0d 00 00    	mov    0xda0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 9dc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 9df:	89 15 a0 0d 00 00    	mov    %edx,0xda0
      return (void*)(p + 1);
 ...
 9f4:	eb e9                	jmp    9df <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 9f6:	c7 05 a0 0d 00 00 a4 	movl   $0xda4,0xda0
 9fd:	0d 00 00 
 a00:	c7 05 a4 0d 00 00 a4 	movl   $0xda4,0xda4
 a07:	0d 00 00 
    base.s.size = 0;
 a0a:	b8 a4 0d 00 00       	mov    $0xda4,%eax
 a0f:	c7 05 a8 0d 00 00 00 	movl   $0x0,0xda8
 a16:	00 00 00 
